...
let map_identifier (env : env) (tok : CST.identifier) =
  (* pattern (r#)?[_\p{XID_Start}][_\p{XID_Continue}]* *) token env tok
...
let map_anon_choice_type_id_f2cdd14 (env : env) (x : CST.anon_choice_type_id_f2cdd14) =
  (match x with
  | `Id tok -> R.Case ("Id",
      (* pattern (r#)?[_\p{XID_Start}][_\p{XID_Continue}]* *) token env tok
    )
...
let map_lifetime (env : env) ((v1, v2) : CST.lifetime) =
  let v1 = (* "'" *) token env v1 in
  let v2 =
    (* pattern (r#)?[_\p{XID_Start}][_\p{XID_Continue}]* *) token env v2
  in
  R.Tuple [v1; v2]
  ...
  | `Field_pat (v1, v2, v3) -> R.Case ("Field_pat",
      ...
      let v3 =
        ...
        | `Id_COLON_pat (v1, v2, v3) -> R.Case ("Id_COLON_pat",
            let v1 =
              (* pattern (r#)?[_\p{XID_Start}][_\p{XID_Continue}]* *) token env v1
            in
            let v2 = (* ":" *) token env v2 in
...
and map_anon_choice_shor_field_init_9cb4441 (env : env) (x : CST.anon_choice_shor_field_init_9cb4441) =
  ...
  | `Field_init (v1, v2, v3, v4) -> R.Case ("Field_init",
      let v1 = R.List (List.map (map_attribute_item env) v1) in
      let v2 = map_anon_choice_type_id_f2cdd14 env v2 in
      let v3 = (* ":" *) token env v3 in
...
and map_declaration_statement (env : env) (x : CST.declaration_statement) =
  (match x with
  | `Const_item (v1, v2, v3, v4, v5, v6, v7) -> R.Case ("Const_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
      ...
      let v3 =
        (* pattern (r#)?[_\p{XID_Start}][_\p{XID_Continue}]* *) token env v3
      in
      let v4 = (* ":" *) token env v4 in
  ...
  | `Macro_defi (v1, v2, v3) -> R.Case ("Macro_defi",
  ...
  | `Mod_item (v1, v2, v3, v4) -> R.Case ("Mod_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
  ...
  | `Fore_mod_item (v1, v2, v3) -> R.Case ("Fore_mod_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
  ...
  | `Struct_item (v1, v2, v3, v4, v5) -> R.Case ("Struct_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
  ...
  | `Union_item (v1, v2, v3, v4, v5, v6) -> R.Case ("Union_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
  ...
  | `Enum_item (v1, v2, v3, v4, v5, v6) -> R.Case ("Enum_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
  ...
  | `Type_item (v1, v2, v3, v4, v5, v6, v7, v8) -> R.Case ("Type_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
  ...
  | `Func_item (v1, v2, v3, v4, v5, v6, v7, v8, v9) -> R.Case ("Func_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
  ...
  | `Func_sign_item (v1, v2, v3, v4, v5, v6, v7, v8, v9) -> R.Case ("Func_sign_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
  ...
  | `Impl_item (v1, v2, v3, v4, v5, v6, v7) -> R.Case ("Impl_item",
      let v1 =
        (match v1 with
        | Some tok -> R.Option (Some (
            (* "unsafe" *) token env tok
  ...
  | `Trait_item (v1, v2, v3, v4, v5, v6, v7, v8) -> R.Case ("Trait_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
      ...
      let v4 =
        (* pattern (r#)?[_\p{XID_Start}][_\p{XID_Continue}]* *) token env v4
      in
      let v5 =
        (match v5 with
        | Some x -> R.Option (Some (
  ...
  | `Asso_type (v1, v2, v3, v4, v5, v6) -> R.Case ("Asso_type",
  ...
  | `Let_decl (v1, v2, v3, v4, v5, v6, v7) -> R.Case ("Let_decl",
  ...
  | `Use_decl (v1, v2, v3, v4) -> R.Case ("Use_decl",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
  ...
  | `Extern_crate_decl (v1, v2, v3, v4, v5, v6) -> R.Case ("Extern_crate_decl",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
  ...
  | `Static_item (v1, v2, v3, v4, v5, v6, v7, v8, v9) -> R.Case ("Static_item",
      let v1 =
        (match v1 with
        | Some x -> R.Option (Some (
            map_visibility_modifier env x
      ...
      in
      let v5 =
        (* pattern (r#)?[_\p{XID_Start}][_\p{XID_Continue}]* *) token env v5
      in
      let v6 = (* ":" *) token env v6 in
...
and map_field_expression (env : env) ((v1, v2, v3) : CST.field_expression) =
  let v1 = map_expression env v1 in
  let v2 = (* "." *) token env v2 in
  let v3 = map_anon_choice_type_id_f2cdd14 env v3 in
  R.Tuple [v1; v2; v3]
...
and map_pattern (env : env) (x : CST.pattern) =
  ...
  | `Range_pat (v1, v2) -> R.Case ("Range_pat",
...
and map_type_parameters (env : env) ((v1, v2, v3, v4, v5, v6) : CST.type_parameters) =
  let v1 = (* "<" *) token env v1 in
  let v2 = R.List (List.map (map_attribute_item env) v2) in
  let v3 = map_anon_choice_life_859e88f env v3 in
  let v4 =
    R.List (List.map (fun (v1, v2, v3) ->
      let v1 = (* "," *) token env v1 in
      let v2 = R.List (List.map (map_attribute_item env) v2) in
