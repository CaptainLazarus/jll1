...
let map_binary_fold_operator (env : env) (x : CST.binary_fold_operator) =
  (match x with
  | `PLUS_DOTDOTDOT_PLUS (v1, v2, v3) -> R.Case ("PLUS_DOTDOTDOT_PLUS",
      let v1 = (* "+" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "+" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `DASH_DOTDOTDOT_DASH (v1, v2, v3) -> R.Case ("DASH_DOTDOTDOT_DASH",
      let v1 = (* "-" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "-" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `STAR_DOTDOTDOT_STAR (v1, v2, v3) -> R.Case ("STAR_DOTDOTDOT_STAR",
      let v1 = (* "*" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "*" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `SLASH_DOTDOTDOT_SLASH (v1, v2, v3) -> R.Case ("SLASH_DOTDOTDOT_SLASH",
      let v1 = (* "/" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "/" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `PERC_DOTDOTDOT_PERC (v1, v2, v3) -> R.Case ("PERC_DOTDOTDOT_PERC",
      let v1 = (* "%" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "%" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `HAT_DOTDOTDOT_HAT (v1, v2, v3) -> R.Case ("HAT_DOTDOTDOT_HAT",
      let v1 = (* "^" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "^" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `AMP_DOTDOTDOT_AMP (v1, v2, v3) -> R.Case ("AMP_DOTDOTDOT_AMP",
      let v1 = (* "&" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "&" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `BAR_DOTDOTDOT_BAR (v1, v2, v3) -> R.Case ("BAR_DOTDOTDOT_BAR",
      let v1 = (* "|" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "|" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `EQ_DOTDOTDOT_EQ (v1, v2, v3) -> R.Case ("EQ_DOTDOTDOT_EQ",
      let v1 = (* "=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `LT_DOTDOTDOT_LT (v1, v2, v3) -> R.Case ("LT_DOTDOTDOT_LT",
      let v1 = (* "<" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "<" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `GT_DOTDOTDOT_GT (v1, v2, v3) -> R.Case ("GT_DOTDOTDOT_GT",
      let v1 = (* ">" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* ">" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `LTLT_DOTDOTDOT_LTLT (v1, v2, v3) -> R.Case ("LTLT_DOTDOTDOT_LTLT",
      let v1 = (* "<<" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "<<" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `GTGT_DOTDOTDOT_GTGT (v1, v2, v3) -> R.Case ("GTGT_DOTDOTDOT_GTGT",
      let v1 = (* ">>" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* ">>" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `PLUSEQ_DOTDOTDOT_PLUSEQ (v1, v2, v3) -> R.Case ("PLUSEQ_DOTDOTDOT_PLUSEQ",
      let v1 = (* "+=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "+=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `DASHEQ_DOTDOTDOT_DASHEQ (v1, v2, v3) -> R.Case ("DASHEQ_DOTDOTDOT_DASHEQ",
      let v1 = (* "-=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "-=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `STAREQ_DOTDOTDOT_STAREQ (v1, v2, v3) -> R.Case ("STAREQ_DOTDOTDOT_STAREQ",
      let v1 = (* "*=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "*=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `SLASHEQ_DOTDOTDOT_SLASHEQ (v1, v2, v3) -> R.Case ("SLASHEQ_DOTDOTDOT_SLASHEQ",
      let v1 = (* "/=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "/=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `PERCEQ_DOTDOTDOT_PERCEQ (v1, v2, v3) -> R.Case ("PERCEQ_DOTDOTDOT_PERCEQ",
      let v1 = (* "%=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "%=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `HATEQ_DOTDOTDOT_HATEQ (v1, v2, v3) -> R.Case ("HATEQ_DOTDOTDOT_HATEQ",
      let v1 = (* "^=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "^=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `AMPEQ_DOTDOTDOT_AMPEQ (v1, v2, v3) -> R.Case ("AMPEQ_DOTDOTDOT_AMPEQ",
      let v1 = (* "&=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "&=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `BAREQ_DOTDOTDOT_BAREQ (v1, v2, v3) -> R.Case ("BAREQ_DOTDOTDOT_BAREQ",
      let v1 = (* "|=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "|=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `GTGTEQ_DOTDOTDOT_GTGTEQ (v1, v2, v3) -> R.Case ("GTGTEQ_DOTDOTDOT_GTGTEQ",
      let v1 = (* ">>=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* ">>=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `LTLTEQ_DOTDOTDOT_LTLTEQ (v1, v2, v3) -> R.Case ("LTLTEQ_DOTDOTDOT_LTLTEQ",
      let v1 = (* "<<=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "<<=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `EQEQ_DOTDOTDOT_EQEQ (v1, v2, v3) -> R.Case ("EQEQ_DOTDOTDOT_EQEQ",
      let v1 = (* "==" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "==" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `BANGEQ_DOTDOTDOT_BANGEQ (v1, v2, v3) -> R.Case ("BANGEQ_DOTDOTDOT_BANGEQ",
      let v1 = (* "!=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "!=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `LTEQ_DOTDOTDOT_LTEQ (v1, v2, v3) -> R.Case ("LTEQ_DOTDOTDOT_LTEQ",
      let v1 = (* "<=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "<=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `GTEQ_DOTDOTDOT_GTEQ (v1, v2, v3) -> R.Case ("GTEQ_DOTDOTDOT_GTEQ",
      let v1 = (* ">=" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* ">=" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `AMPAMP_DOTDOTDOT_AMPAMP (v1, v2, v3) -> R.Case ("AMPAMP_DOTDOTDOT_AMPAMP",
      let v1 = (* "&&" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "&&" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `BARBAR_DOTDOTDOT_BARBAR (v1, v2, v3) -> R.Case ("BARBAR_DOTDOTDOT_BARBAR",
      let v1 = (* "||" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "||" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `COMMA_DOTDOTDOT_COMMA (v1, v2, v3) -> R.Case ("COMMA_DOTDOTDOT_COMMA",
      let v1 = (* "," *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "," *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `DOTSTAR_DOTDOTDOT_DOTSTAR (v1, v2, v3) -> R.Case ("DOTSTAR_DOTDOTDOT_DOTSTAR",
      let v1 = (* ".*" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* ".*" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `DASHGTSTAR_DOTDOTDOT_DASHGTSTAR (v1, v2, v3) -> R.Case ("DASHGTSTAR_DOTDOTDOT_DASHGTSTAR",
      let v1 = (* "->*" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "->*" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `Or_DOTDOTDOT_or (v1, v2, v3) -> R.Case ("Or_DOTDOTDOT_or",
      let v1 = (* "or" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "or" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `And_DOTDOTDOT_and (v1, v2, v3) -> R.Case ("And_DOTDOTDOT_and",
      let v1 = (* "and" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "and" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `Bitor_DOTDOTDOT_bitor (v1, v2, v3) -> R.Case ("Bitor_DOTDOTDOT_bitor",
      let v1 = (* "bitor" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "bitor" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `Xor_DOTDOTDOT_xor (v1, v2, v3) -> R.Case ("Xor_DOTDOTDOT_xor",
      let v1 = (* "xor" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "xor" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `Bitand_DOTDOTDOT_bitand (v1, v2, v3) -> R.Case ("Bitand_DOTDOTDOT_bitand",
      let v1 = (* "bitand" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "bitand" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  | `Not_eq_DOTDOTDOT_not_eq (v1, v2, v3) -> R.Case ("Not_eq_DOTDOTDOT_not_eq",
      let v1 = (* "not_eq" *) token env v1 in
      let v2 = (* "..." *) token env v2 in
      let v3 = (* "not_eq" *) token env v3 in
      R.Tuple [v1; v2; v3]
    )
  )
...
let map_anon_choice_field_id_d3c4b5f (env : env) (x : CST.anon_choice_field_id_d3c4b5f) =
  (match x with
  | `Id tok -> R.Case ("Id",
      (* pattern (\p{XID_Start}|\$|_|\\u[0-9A-Fa-f]{4}|\\U[0-9A-Fa-f]{8})(\p{XID_Continue}|\$|\\u[0-9A-Fa-f]{4}|\\U[0-9A-Fa-f]{8})* *) token env tok
    )
...
let map_anon_choice_field_id_1a79fc3 (env : env) (x : CST.anon_choice_field_id_1a79fc3) =
  (match x with
  | `Id tok -> R.Case ("Id",
      (* pattern (\p{XID_Start}|\$|_|\\u[0-9A-Fa-f]{4}|\\U[0-9A-Fa-f]{8})(\p{XID_Continue}|\$|\\u[0-9A-Fa-f]{4}|\\U[0-9A-Fa-f]{8})* *) token env tok
    )
...
let map_anon_choice_field_id_fe6e1ce (env : env) (x : CST.anon_choice_field_id_fe6e1ce) =
  (match x with
  | `Id tok -> R.Case ("Id",
      (* pattern (\p{XID_Start}|\$|_|\\u[0-9A-Fa-f]{4}|\\U[0-9A-Fa-f]{8})(\p{XID_Continue}|\$|\\u[0-9A-Fa-f]{4}|\\U[0-9A-Fa-f]{8})* *) token env tok
    )
...
let map_anon_choice_field_id_dd8d494 (env : env) (x : CST.anon_choice_field_id_dd8d494) =
  (match x with
  | `Id tok -> R.Case ("Id",
      (* pattern (\p{XID_Start}|\$|_|\\u[0-9A-Fa-f]{4}|\\U[0-9A-Fa-f]{8})(\p{XID_Continue}|\$|\\u[0-9A-Fa-f]{4}|\\U[0-9A-Fa-f]{8})* *) token env tok
    )
...
let map_preproc_params (env : env) ((v1, v2, v3) : CST.preproc_params) =
  ...
  let v2 =
    (match v2 with
    | Some (v1, v2) -> R.Option (Some (
        let v1 = map_anon_choice_field_id_d3c4b5f env v1 in
        let v2 =
          R.List (List.map (fun (v1, v2) ->
            let v1 = (* "," *) token env v1 in
            let v2 = map_anon_choice_field_id_d3c4b5f env v2 in
            R.Tuple [v1; v2]
          ) v2)
        in
        R.Tuple [v1; v2]
...
let map_old_style_parameter_list (env : env) ((v1, v2, v3) : CST.old_style_parameter_list) =
  ...
  let v2 =
    (match v2 with
    | Some (v1, v2) -> R.Option (Some (
        let v1 = map_anon_choice_field_id_fe6e1ce env v1 in
        let v2 =
          R.List (List.map (fun (v1, v2) ->
            let v1 = (* "," *) token env v1 in
            let v2 = map_anon_choice_field_id_fe6e1ce env v2 in
            R.Tuple [v1; v2]
          ) v2)
        in
        R.Tuple [v1; v2]
...
let map_anon_choice_field_id_7bae85c (env : env) (x : CST.anon_choice_field_id_7bae85c) =
  (match x with
  | `Id tok -> R.Case ("Id",
      (* pattern (\p{XID_Start}|\$|_|\\u[0-9A-Fa-f]{4}|\\U[0-9A-Fa-f]{8})(\p{XID_Continue}|\$|\\u[0-9A-Fa-f]{4}|\\U[0-9A-Fa-f]{8})* *) token env tok
    )
...
let map_string_ (env : env) (x : CST.string_) =
  ...
  | `Conc_str (v1, v2, v3) -> R.Case ("Conc_str",
      let v1 = map_anon_choice_field_id_dd8d494 env v1 in
      let v2 =
        (match v2 with
        | `Str_lit x -> R.Case ("Str_lit",
            map_string_literal env x
      ...
      in
      let v3 =
        R.List (List.map (map_anon_choice_field_id_dd8d494 env) v3)
      in
      R.Tuple [v1; v2; v3]
    )
  )
...
let map_namespace_alias_definition (env : env) ((v1, v2, v3, v4, v5) : CST.namespace_alias_definition) =
  ...
  in
  let v3 = (* "=" *) token env v3 in
  let v4 = map_anon_choice_field_id_7bae85c env v4 in
...
and map_lambda_capture (env : env) (x : CST.lambda_capture) =
  ...
  | `Lambda_capt_id (v1, v2) -> R.Case ("Lambda_capt_id",
      let v1 =
        (match v1 with
        | Some tok -> R.Option (Some (
            (* "&" *) token env tok
  ...
  | `Lambda_capt_init (v1, v2, v3, v4, v5) -> R.Case ("Lambda_capt_init",
      let v1 =
        (match v1 with
        | Some tok -> R.Option (Some (
            (* "&" *) token env tok
...
and map_namespace_definition (env : env) ((v1, v2, v3, v4, v5) : CST.namespace_definition) =
  ...
  let v4 =
    (match v4 with
    | Some x -> R.Option (Some (
        map_anon_choice_field_id_7bae85c env x
      ))
    | None -> R.Option None)
  in
...
and map_sized_type_specifier (env : env) (x : CST.sized_type_specifier) =
  ...
  | `Rep_choice_signed_opt_choice_id_rep1_choice_signed (v1, v2, v3) -> R.Case ("Rep_choice_signed_opt_choice_id_rep1_choice_signed",
      ...
      let v2 =
        (match v2 with
        | Some x -> R.Option (Some (
            map_anon_choice_field_id_1a79fc3 env x
          ))
        | None -> R.Option None)
      in
      let v3 =
