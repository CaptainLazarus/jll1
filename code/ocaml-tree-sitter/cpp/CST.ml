...
type binary_fold_operator = [
    `PLUS_DOTDOTDOT_PLUS of (
        Token.t (* "+" *) * Token.t (* "..." *) * Token.t (* "+" *)
    )
  | `DASH_DOTDOTDOT_DASH of (
        Token.t (* "-" *) * Token.t (* "..." *) * Token.t (* "-" *)
    )
  | `STAR_DOTDOTDOT_STAR of (
        Token.t (* "*" *) * Token.t (* "..." *) * Token.t (* "*" *)
    )
  | `SLASH_DOTDOTDOT_SLASH of (
        Token.t (* "/" *) * Token.t (* "..." *) * Token.t (* "/" *)
    )
  | `PERC_DOTDOTDOT_PERC of (
        Token.t (* "%" *) * Token.t (* "..." *) * Token.t (* "%" *)
    )
  | `HAT_DOTDOTDOT_HAT of (
        Token.t (* "^" *) * Token.t (* "..." *) * Token.t (* "^" *)
    )
  | `AMP_DOTDOTDOT_AMP of (
        Token.t (* "&" *) * Token.t (* "..." *) * Token.t (* "&" *)
    )
  | `BAR_DOTDOTDOT_BAR of (
        Token.t (* "|" *) * Token.t (* "..." *) * Token.t (* "|" *)
    )
  | `EQ_DOTDOTDOT_EQ of (
        Token.t (* "=" *) * Token.t (* "..." *) * Token.t (* "=" *)
  ...
  | `LTLT_DOTDOTDOT_LTLT of (
        Token.t (* "<<" *) * Token.t (* "..." *) * Token.t (* "<<" *)
    )
  | `GTGT_DOTDOTDOT_GTGT of (
        Token.t (* ">>" *) * Token.t (* "..." *) * Token.t (* ">>" *)
    )
  | `PLUSEQ_DOTDOTDOT_PLUSEQ of (
        Token.t (* "+=" *) * Token.t (* "..." *) * Token.t (* "+=" *)
    )
  | `DASHEQ_DOTDOTDOT_DASHEQ of (
        Token.t (* "-=" *) * Token.t (* "..." *) * Token.t (* "-=" *)
    )
  | `STAREQ_DOTDOTDOT_STAREQ of (
        Token.t (* "*=" *) * Token.t (* "..." *) * Token.t (* "*=" *)
    )
  | `SLASHEQ_DOTDOTDOT_SLASHEQ of (
        Token.t (* "/=" *) * Token.t (* "..." *) * Token.t (* "/=" *)
    )
  | `PERCEQ_DOTDOTDOT_PERCEQ of (
        Token.t (* "%=" *) * Token.t (* "..." *) * Token.t (* "%=" *)
    )
  | `HATEQ_DOTDOTDOT_HATEQ of (
        Token.t (* "^=" *) * Token.t (* "..." *) * Token.t (* "^=" *)
    )
  | `AMPEQ_DOTDOTDOT_AMPEQ of (
        Token.t (* "&=" *) * Token.t (* "..." *) * Token.t (* "&=" *)
    )
  | `BAREQ_DOTDOTDOT_BAREQ of (
        Token.t (* "|=" *) * Token.t (* "..." *) * Token.t (* "|=" *)
    )
  | `GTGTEQ_DOTDOTDOT_GTGTEQ of (
        Token.t (* ">>=" *) * Token.t (* "..." *) * Token.t (* ">>=" *)
    )
  | `LTLTEQ_DOTDOTDOT_LTLTEQ of (
        Token.t (* "<<=" *) * Token.t (* "..." *) * Token.t (* "<<=" *)
    )
  | `EQEQ_DOTDOTDOT_EQEQ of (
        Token.t (* "==" *) * Token.t (* "..." *) * Token.t (* "==" *)
    )
  | `BANGEQ_DOTDOTDOT_BANGEQ of (
        Token.t (* "!=" *) * Token.t (* "..." *) * Token.t (* "!=" *)
    )
  | `LTEQ_DOTDOTDOT_LTEQ of (
        Token.t (* "<=" *) * Token.t (* "..." *) * Token.t (* "<=" *)
    )
  | `GTEQ_DOTDOTDOT_GTEQ of (
        Token.t (* ">=" *) * Token.t (* "..." *) * Token.t (* ">=" *)
    )
  | `AMPAMP_DOTDOTDOT_AMPAMP of (
        Token.t (* "&&" *) * Token.t (* "..." *) * Token.t (* "&&" *)
    )
  | `BARBAR_DOTDOTDOT_BARBAR of (
        Token.t (* "||" *) * Token.t (* "..." *) * Token.t (* "||" *)
    )
  | `COMMA_DOTDOTDOT_COMMA of (
        Token.t (* "," *) * Token.t (* "..." *) * Token.t (* "," *)
    )
  | `DOTSTAR_DOTDOTDOT_DOTSTAR of (
        Token.t (* ".*" *) * Token.t (* "..." *) * Token.t (* ".*" *)
    )
  | `DASHGTSTAR_DOTDOTDOT_DASHGTSTAR of (
        Token.t (* "->*" *) * Token.t (* "..." *) * Token.t (* "->*" *)
    )
  | `Or_DOTDOTDOT_or of (
        Token.t (* "or" *) * Token.t (* "..." *) * Token.t (* "or" *)
    )
  | `And_DOTDOTDOT_and of (
        Token.t (* "and" *) * Token.t (* "..." *) * Token.t (* "and" *)
    )
  | `Bitor_DOTDOTDOT_bitor of (
        Token.t (* "bitor" *) * Token.t (* "..." *) * Token.t (* "bitor" *)
    )
  | `Xor_DOTDOTDOT_xor of (
        Token.t (* "xor" *) * Token.t (* "..." *) * Token.t (* "xor" *)
    )
  | `Bitand_DOTDOTDOT_bitand of (
        Token.t (* "bitand" *) * Token.t (* "..." *) * Token.t (* "bitand" *)
    )
  | `Not_eq_DOTDOTDOT_not_eq of (
        Token.t (* "not_eq" *) * Token.t (* "..." *) * Token.t (* "not_eq" *)
    )
]
...
type anon_choice_field_id_d3c4b5f = [
...
type anon_choice_field_id_1a79fc3 = [
    `Id of identifier (*tok*)
...
type anon_choice_field_id_fe6e1ce = [
    `Id of identifier (*tok*)
...
type anon_choice_field_id_dd8d494 = [
    `Id of identifier (*tok*)
...
type preproc_params = (
    imm_tok_lpar (*tok*)
  * (
        anon_choice_field_id_d3c4b5f
      * (Token.t (* "," *) * anon_choice_field_id_d3c4b5f)
          list (* zero or more *)
    )
      option
  * Token.t (* ")" *)
...
type old_style_parameter_list = (
    Token.t (* "(" *)
  * (
        anon_choice_field_id_fe6e1ce
      * (Token.t (* "," *) * anon_choice_field_id_fe6e1ce)
          list (* zero or more *)
    )
      option
  * Token.t (* ")" *)
...
type anon_choice_field_id_7bae85c = [
    `Id of identifier (*tok*)
  | `Nested_name_spec of nested_namespace_specifier
]
...
and namespace_definition = (
  ...
  * anon_choice_field_id_7bae85c option
  * declaration_list
)
...
and sized_type_specifier = [
    `Rep_choice_signed_opt_choice_id_rep1_choice_signed of (
      ...
      * anon_choice_field_id_1a79fc3 option
...
type lambda_capture_identifier (* inlined *) = (
    Token.t (* "&" *) option
  * [
        `Id of identifier (*tok*)
      | `Qual_id of qualified_identifier
...
type lambda_capture_initializer (* inlined *) = (
    Token.t (* "&" *) option
  * Token.t (* "..." *) option
  * identifier (*tok*)
  * Token.t (* "=" *)
